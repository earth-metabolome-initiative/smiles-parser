...
use crate::smiles::{
    BondMatrixBuilder, Smiles,
    canonicalization::{
        state::{CanonicalStereoNeighborKey, canonical_stereo_neighbor_key},
...
pub(crate) fn permute_smiles(smiles: &Smiles, order: &[usize]) -> Smiles {
...
#[track_caller]
pub(crate) fn same_canonicalization_state(left: &Smiles, right: &Smiles) {
