...
pub struct SmilesComponents<'a> {
    inner: GeometricConnectedComponentsResult<'a, Smiles, usize>,
}

impl<'a> SmilesComponents<'a> {
    #[inline]
    pub(crate) const fn new(inner: GeometricConnectedComponentsResult<'a, Smiles, usize>) -> Self {
        Self { inner }
    }
